...
class houselandlordComponent extends Component {
    constructor(props) {
        super(props)
        this.state = {// 组件数据
            list: [],
    ...
    get = () => {//查 done
        ...
        post('/landlord/house/get', params).then(res => {
            ...
            return (
                ...
                >
                    ...
                    >
                        ...
                        <Form.Item name="uuid" label="编号" hidden={this.state.editmodal.type === "create" ? true : false}><Input type="textarea" /></Form.Item>
                        ...
                        <Form.Item name="description" label="详情描述"><Input.TextArea /></Form.Item>
                        ...
                        <Form.Item name="addr" label="具体地址"><Input.TextArea /></Form.Item>
        ...
        return (
            <div>
                ...
                <Space size="middle" wrap>
                    ...
                    <Button onClick={() => { this.showeditmodal({}, "create") }} >发布房源</Button>
...
export default houselandlordComponent;
